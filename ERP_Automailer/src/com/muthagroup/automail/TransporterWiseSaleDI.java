...
public class TransporterWiseSaleDI extends TimerTask {

	@Override
	public void run() {
		/**************************************************************************************
		-- To Pay List ===>
		exec "DIERP"."dbo"."Sel_TransporterWiseSale";1 '105', '0', '101021101006101003101025101019101001101014101015101008101004101009101007101002101024101005101010101016101022101011101018101023101017101013101012101020', '20150331', '20150401', N'1'
		-- Paid ===>
		exec "DIERP"."dbo"."Sel_TransporterWiseSale";1 '105', '0', '101021101006101003101025101019101001101014101015101008101004101009101007101002101024101005101010101016101022101011101018101023101017101013101012101020', '20150331', '20150401', N'0'
		**************************************************************************************/
		...
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 23 && d.getMinutes() == 48) {
		...
		try {
			...
			PreparedStatement pstrname=con.prepareStatement("select * from DIERP..MSTCOMMTRANSPORT");
		...
		String subject = "DI Transporter Wise Sale List of " + CurrentDate; 
		boolean sessionDebug = false;
		// *********************************************************************************************
		// multiple recipients : == >
		// ********************************************************************************************* 
		String recipients[] = {"ankatariya@muthagroup.com"};
		String cc_recipients[] = {"nileshss@muthagroup.com","internalaudit@muthagroup.com","srpatekar@muthagroup.com","jginamdar@muthagroup.com","parikshitap@muthagroup.com","marketing@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for DI Transporter Wise Sale List !!! ***</b>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("Transport 24 !!!"); 
	}
