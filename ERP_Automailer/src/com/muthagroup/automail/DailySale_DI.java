...
public class DailySale_DI extends TimerTask {
	...
	public void run() {
		try {
			...
			/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 42){*/
				//************************************************************************************************
		//		System.out.println("Date before  =  " +yes_date+"\n date before = "+ason_date);
				...
				String subject = "Daily Sale Report of DI !!!"; 
				boolean sessionDebug = false;
				// *********************************************************************************************
				// multiple recipients : == >
				// *********************************************************************************************
				String recipients[] = {"azmutha@muthagroup.com","meghana@muthagroup.com","kunalvm@muthagroup.com","adgadkari@muthagroup.com","internalaudit@muthagroup.com","vmjoshi@muthagroup.com","kamlesh@muthagroup.com","jbaphna@muthagroup.com","nrfirodia@muthagroup.com"};
				...
				"<div style='width: 65%;float: left;'><b style='font-family: Arial;font-size: 14px;'>DHANASHREE INDUSTRIES Daily Sale Report as on "+ason_date +"</b></div>"+
	...
	System.out.println("ERP Mailer 14");	
	} 
}
