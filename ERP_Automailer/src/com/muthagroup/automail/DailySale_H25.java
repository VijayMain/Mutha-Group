...
public class DailySale_H25 extends TimerTask {
	...
	public void run() {
		try {
			...
			if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10  && d.getMinutes() == 12) {
			/*	if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 40){*/
				...
				String subject = "Daily Sale Report of MEPL H25 !!!"; 
				...
				sb.append("<b style='color: #0D265E;font-family: Arial;font-size: 11px;'>*** This is an automatically generated email of Daily Sale Report !!! ***</b> <br />"+
						"<div style='width: 65%;float: left;'><b style='font-family: Arial;font-size: 14px;'>H25 MUTHA ENGINEERING PVT.LTD. Daily Sale Report as on "+ason_date +"</b></div>"+
	...
	System.out.println("ERP Mailer 12");	
	}
