...
public class Pending_Challan57f4_MFPL extends TimerTask {
	...
	public void run() {
		try{
			...
			PreparedStatement ps_rec = conLocal.prepareStatement("select * from pending_approvee where type='to' and report='Pending_Challan57f4_MFPL'");
			...
			sb.append("<b style='color: #0D265E;'>This is an automatically generated email for ERP - Pending Challan 57f4 List of MFPL</b>");
