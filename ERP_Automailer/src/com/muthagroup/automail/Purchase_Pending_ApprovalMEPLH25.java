...
public class Purchase_Pending_ApprovalMEPLH25 extends TimerTask {
	...
	public void run() {
		...
		if ((!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 02)||(!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 02)) {
		try {
		...
		String subject = "Purchase Pending Approvals of MEPL H25 !!!"; 
		boolean sessionDebug = false;
		// *********************************************************************************************
		// multiple recipients : == >
		// ********************************************************************************************* 
		String recipients[] = {"ankatariya@muthagroup.com","mahesh@muthagroup.com"};
		String cc_recipients[] = {"kunalvm@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase Pending Approvals of MEPL H25 !!! ***</b>"+
		...
		System.out.println("ERP Mailer 2");	
		}
