...
public class SheduleEntryReminder extends TimerTask {

	@Override
	public void run() {
		try {
			System.out.println("Schedule Report Arial h21");
			//-------------------------------------------------------- Date Logic ---------------------------------------------------------
			Date d = new Date();
			...
			//************************************************************************************************				
				...
				sb.append("<b  style='font-family: Arial;font-size: 10px;color: #0D265E;'>*** This is an automatically generated email from ERP System for Monthly Dispatch Schedule of  MEPL H21 !!! ***</b>");
			 	//----------------------------------------------------------------------------------------------------------------
	...
	sb.append("<p  style='font-family: Arial;font-size: 12px;'><a href='http://192.168.0.7/foundrymis/' style='text-decoration: none; color: green;'>Click and find details from Dispatch Plan Vs Sale Report</a>"+
			"</p><table border='1' width='92%' style='font-family: Arial;'>"+
				"<tr style='font-size: 11px;border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center;'>"+
					"<td colspan='10' height='20'><b style='font-family: Arial; font-size: 11px;'>Dispatch Schedule of MEPL H21 on "+ todays_date +" (Please Note : All Amounts in lakhs)  </b></td>"+
				...
				sb.append("<table border='1' width='80%' style='font-family: Arial;'>"+
						...
						"<td colspan='3' height='20'><b style='font-family: Arial; font-size: 11px;'>Dispatch Schedule of MEPL H21 on "+todays_date+"</b></td></tr>"+
