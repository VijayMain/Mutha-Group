...
public class Pending_Challan57f4 extends TimerTask {
	@Override
	public void run() {
		try{
			System.out.println("ERP 57f4 Pending Approval H21 !!!");
			
			Date d = new Date();
			Date datesq = new Date();
			int day = datesq.getDate();
			
			if (day==1 && d.getHours() == 8 && d.getMinutes() == 10) {
				...
				/*System.out.println("Date H21 = " + nowDate);*/
			...
			String subject = "57F4 challans pending for over 30 days of MEPL H21";
			boolean sessionDebug = false;
			// *********************************************************************************************
			// multiple recipients : == >
			// *********************************************************************************************
			ArrayList to_emails = new ArrayList();
			PreparedStatement ps_rec = conLocal.prepareStatement("select * from pending_approvee where type='to' and report='Pending_Challan57f4_H21'");
			...
			sb.append("<b style='color: #0D265E;'>This is an automatically generated email for ERP - Pending Challan 57f4 List of MEPL H21</b>");
