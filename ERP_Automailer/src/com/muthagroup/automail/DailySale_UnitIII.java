	...
	public void run() {
		try {
			...
			/*	if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 41){*/
				...
				// multiple recipients : == >
				// ********************************************************************************************* 
				String recipients[] = {"azmutha@muthagroup.com","ssgare@muthagroup.com","kunalvm@muthagroup.com","adgadkari@muthagroup.com","internalaudit@muthagroup.com","vmjoshi@muthagroup.com","ankatariya@muthagroup.com","jbaphna@muthagroup.com","nrfirodia@muthagroup.com"};
