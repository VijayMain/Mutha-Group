...
public class MIS_SummaryReportK1 extends TimerTask {
	...
	public void run() {
		try {
			System.out.println("MIS Report K1");
			//-------------------------------------------------------- Date Logic ---------------------------------------------------------
			...
			if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 13 && d.getMinutes() == 55) {
			...
			if(weekday[d.getDay()].equals("Wednesday")){
			   ...
			   String batchonDate = "01"+"/"+ OnDateMIS.substring(4,6) +"/"+ OnDateMIS.substring(0,4);
				...
				String subject = "MIS Summary Report ("+ason_date+") of MEPL UIII !!!";
				boolean sessionDebug = false;
				// *********************************************************************************************
				// multiple recipients : == >
				// *********************************************************************************************			 
				ArrayList to_emails = new ArrayList();
				String report_name = "MIS_Report_K1";
				Connection conLocal = ConnectionUrl.getLocalDatabase();
				...
				"<div style='width: 65%;float: left;'><b style='font-family: Arial;font-size: 14px;'>MEPL UNIT III MIS Summary Report as on "+ason_date +"</b></div>");
