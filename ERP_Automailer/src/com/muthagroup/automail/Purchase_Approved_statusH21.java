...
public class Purchase_Approved_statusH21 extends TimerTask {
	...
	public void run() {
		...
		try { 
			...
			if(d.getHours() == 10 && d.getMinutes() == 15){
		...
		String cc_recipients[] = {"kunalvm@muthagroup.com","adgadkari@muthagroup.com","ankatariya@muthagroup.com","vijaybm@muthagroup.com","internalaudit@muthagroup.com","h21store@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase  Approved PO of MEPL H21 !!! ***</b>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("Aprroved Mail 11 !!!");
	}
}
