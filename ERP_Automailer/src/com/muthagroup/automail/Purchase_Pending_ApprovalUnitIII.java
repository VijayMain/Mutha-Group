...
public class Purchase_Pending_ApprovalUnitIII extends TimerTask {
	...
	public void run() {
		...
		if ((!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 05)||(!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 05)) {
		try {
		...
		System.out.println("ERP K1 Automailer....");
		String host = "send.one.com";
		String user = "itsupports@muthagroup.com";
		String pass = "itsupports@xyz"; 
 		String from = "itsupports@muthagroup.com";
		String subject = "Purchase Pending Approvals of MEPL Unit III !!!"; 
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase Pending Approvals of MEPL Unit III !!! ***</b>"+
		...
		// ******************************************************************************
		transport.close(); 
		System.out.println("ERP k1 loop End");		
		}				
			con.close();
	} catch (Exception e) {
	 e.printStackTrace();
	}  
		System.out.println("ERP Mailer 5");	
		}
