...
public class MIS_SummaryReportFND extends TimerTask {
	...
	public void run() {
		try {
			System.out.println("MIS Report 1");
			//-------------------------------------------------------- Date Logic ---------------------------------------------------------
			...
			if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 49) {
				...
				DecimalFormat threeDForm = new DecimalFormat("0.###"); 
				
				sb.append("<table border='1' class='tftable'><tr style='font-size: 10px; color: #333333; width: 90%; border-width: 1px; border-color: #729ea5; border-collapse: collapse;'>"+
				"<th scope='col' colspan='3'>Batch Production From "+batchonDate +" to "+OnDate +"</th> </tr>"+
				"<tr style='font-size: 12px; background-color: #acc8cc; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center;'>"+
				"<th scope='col'>Item</th> <th scope='col'>Qty</th> <th scope='col'>Total Mixes</th> </tr>"+
				"<tr style='font-size: 10px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5;'>"+
				"<td title='Click to get details'>RESINE COATED SAND 3.8 % </td><td title='Click to get details' align='right'>"+threeDForm.format(sumrc/1000)+"</td>"+
				"<td title='Click to get details' align='right'>"+summix +"</td></tr>"+
				"<tr style='font-size: 10px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5;'>"+
				"<td title='Click to get details'>RAW SILICA SAND RECLAIMED</td>"+
				"<td title='Click to get details' align='right'>"+threeDForm.format(sumrs/1000)+"</td>"+
