...
public class MIS_SummaryReportDI extends TimerTask {

	@Override
	public void run() {
		try {
			System.out.println("MIS Report 3");
			//-------------------------------------------------------- Date Logic ---------------------------------------------------------
			...
			if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 17 && d.getMinutes() == 05) { 
			//************************************************************************************************				
				...
				String subject = "MIS Summary Report("+ason_date+") of DI."; 
				...
				"<div style='width: 65%;float: left;'><b style='font-family: Arial;font-size: 14px;'>DHANASHREE INDUSTRIES MIS Summary Report as on " + ason_date + "</b></div>");
