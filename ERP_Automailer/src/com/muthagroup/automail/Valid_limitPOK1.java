...
public class Valid_limitPOK1 extends TimerTask {

	@Override
	public void run() {
		try {
			System.out.println("Validity Limit PO K1 !!!");
			Date d = new Date();
			String weekday[] = { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" };
			
			if(!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 28){ 			
			...
			/******************************************************************************************************** */
			 	conerp  = ConnectionUrl.getK1ERPConnection();
					report = "PO_ValidLimitK1";
					company = "MEPL UNIT III";
					comp = "106"; 
