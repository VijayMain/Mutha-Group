...
public class SheduleEntryRemindermfpl extends TimerTask {

	@Override
	public void run() {
		try {
			System.out.println("Schedule Report Arial MFPL");
			//-------------------------------------------------------- Date Logic ---------------------------------------------------------
			Date d = new Date();
			boolean flag = true;
			...
			/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 12 && d.getMinutes() == 42) {*/
			//************************************************************************************************				
				int cnt = 0;
			...
			// ***************************************************************************************************************
				...
				String subject = "Dispatch Schedule of MFPL on " + todays_date;
				...
				emailList.add("vahalkar@muthagroup.com");
				emailList.add("asbe@muthagroup.com");
				emailList.add("sanjay@muthagroup.com");
				emailList.add("prbhosale@muthagroup.com");
				emailList.add("prmallewadikar@muthagroup.com");
				...
				sb.append("<b  style='font-family: Arial;font-size: 10px;color: #0D265E;'>*** This is an automatically generated email from ERP System for Monthly Dispatch Schedule of  MFPL !!! ***</b>");
			 	//----------------------------------------------------------------------------------------------------------------
				
				Connection con = ConnectionUrl.getFoundryERPNEWConnection();
				
				String matcode = "";
				PreparedStatement ps_code = con.prepareStatement("select * from FOUNDRYERPNEW..MSTACCTGLSUB where SUB_GLCODE='11'");
			...
			"</p><table border='1' width='92%' style='font-family: Arial;'>"+
				"<tr style='font-size: 11px;border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center;'>"+
					"<td colspan='10' height='20'><b style='font-family: Arial; font-size: 11px;'>Dispatch Schedule of MFPL on "+ todays_date +" (Please Note : All Amounts in lakhs)</b></td>"+
				...
				sb.append("<table border='1' width='80%' style='font-family: Arial;'>"+
						...
						"<td colspan='3' height='20'><b style='font-family: Arial; font-size: 11px;'>Dispatch Schedule of  MFPL on "+todays_date+"</b></td></tr>"+
						"<tr style='font-size: 11px;' align='center'><td colspan='3' style='font-size: 13px;'>"+
						"<p><b style='color: red;'>Alert &#8680; No Schedule for MFPL !!!</b></p></td></tr></table>");
					}
