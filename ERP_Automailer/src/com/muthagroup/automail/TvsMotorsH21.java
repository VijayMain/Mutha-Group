	...
	public void run() { 
		try {
			...
			if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 11) {
				...
				System.out.println("ERP DailySale Automailer Starts TVS !!!");
				String host = "send.one.com";
				String user = "itsupports@muthagroup.com";
				String pass = "itsupports@xyz";
		 		String from = "itsupports@muthagroup.com";
				String subject = "MEPL H21 Daily Sale Report of TVS motor !!!"; 
				boolean sessionDebug = false;
				// *********************************************************************************************
				// multiple recipients : == >
				// ********************************************************************************************* 
				/*String recipients[] = {"ssgare@muthagroup.com","kunalvm@muthagroup.com","internalaudit@muthagroup.com","vmjoshi@muthagroup.com","asshete@muthagroup.com","jbaphna@muthagroup.com","nrfirodia@muthagroup.com","vvsamant@muthagroup.com"};
...
"<div style='text-align: right;font-family: Arial;font-size: 12px;float:right; width: 30%'><b>Please Note: </b>All Records is in lakhs&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>"+
	...
	System.out.println("ERP Mailer TVS");	
	}
}
