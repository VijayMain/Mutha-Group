...
public class DailySale_H21 extends TimerTask {
	...
	public void run() {
		try {
			...
			if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 11) {
				/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 39){*/
				//************************************************************************************************
				...
				String subject = "Daily Sale Report of MEPL H21 !!!"; 
				boolean sessionDebug = false;
				// *********************************************************************************************
				// multiple recipients : == >
				// ********************************************************************************************* 
				String recipients[] = {"azmutha@muthagroup.com","ssgare@muthagroup.com","kunalvm@muthagroup.com","adgadkari@muthagroup.com","internalaudit@muthagroup.com","vmjoshi@muthagroup.com","asshete@muthagroup.com","jbaphna@muthagroup.com","nrfirodia@muthagroup.com","vvsamant@muthagroup.com"};
...
"<div style='width: 65%;float: left;'><b style='font-family: Arial;font-size: 14px;'>H21 MUTHA ENGINEERING PVT.LTD. Daily Sale Report as on "+ason_date +"</b></div>"+
"<div style='text-align: right;font-family: Arial;font-size: 12px;float:right; width: 30%'><b>Please Note: </b>All Records is in lakhs&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>"+
	...
	System.out.println("ERP Mailer 11");	
	}
