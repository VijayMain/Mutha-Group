...
public class Purchase_PendDues_Stat25 extends TimerTask {
	...
	public void run() {
		...
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 15 && d.getMinutes() == 39) {
		try {
			String comp = "102";
			...
			ArrayList codes = new ArrayList();
			 PreparedStatement ps=con.prepareStatement("select * from H25ERP..MSTACCTGLSUB where SUB_GLCODE='12'");
		    ...
		    while(rs.next()){
		    	if(!rs.getString("TRAN_TYPE").equalsIgnoreCase("103")){
				    ...
				    sr++;		    
					    ...
					    ps_category = con.prepareStatement("select * from H25ERP..MSTMATCATAG  where CODE='"+rs.getString("CATEGOARY")+"'");
		...
		String cc_recipients[] = {"nileshss@muthagroup.com","adgadkari@muthagroup.com","internalaudit@muthagroup.com","kunalvm@muthagroup.com","ankatariya@muthagroup.com","mahesh@muthagroup.com","govindmb@muthagroup.com"};
		...
		sb.append("<p style='font-size: 12px;'>*** This is an automatically generated alert email for Over due vendor payment of MEPL H25 !!! ***</p>");
		 
		sb.append("<p style='font-size: 13px;'>Please find below attachment for Overdue Vendor Payment of MEPL H25.</p>");
	 ...
	 e.printStackTrace();
		...
		System.out.println("Purchase Due 17 !!!");
	}
