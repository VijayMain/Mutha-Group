...
public class Purchase_Pending_ApprovalDI extends TimerTask {
	...
	public void run() {
		...
		if ((!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 04)||(!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 04)) {
		try {
		...
		System.out.println("Email Automailer DI....");
		String host = "send.one.com";
		String user = "itsupports@muthagroup.com";
		String pass = "itsupports@xyz"; 
 		String from = "itsupports@muthagroup.com";
		String subject = "Purchase Pending Approvals of DI !!!"; 
		boolean sessionDebug = false;
		// *********************************************************************************************
		// multiple recipients : == >
		// ********************************************************************************************* 
		String recipients[] = {"ankatariya@muthagroup.com","kamlesh@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase Pending Approvals of DI !!! ***</b>"+
		...
		// ******************************************************************************
		transport.close(); 
		System.out.println("ERP DI Loop End");
	 ...
	 e.printStackTrace();
		...
		System.out.println("ERP Mailer 4");	
		}
