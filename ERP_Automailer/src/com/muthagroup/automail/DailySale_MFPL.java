	...
	public void run() {
		try {
			...
			/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 38){*/
				...
				// multiple recipients : == >
				// ********************************************************************************************* 
				String recipients[] = {"jyjagtap@muthagroup.com","ssgare@muthagroup.com","kunalvm@muthagroup.com","internalaudit@muthagroup.com","vmjoshi@muthagroup.com","vahalkar@muthagroup.com","jbaphna@muthagroup.com","nrfirodia@muthagroup.com"};
