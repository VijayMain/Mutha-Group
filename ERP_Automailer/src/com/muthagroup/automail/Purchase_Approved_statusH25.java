...
public class Purchase_Approved_statusH25 extends TimerTask {
	...
	public void run() {
		...
		if ((!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 16)||(!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16  && d.getMinutes() == 11)) {
		/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 11 && d.getMinutes() == 16) {*/
		try { 
			...
			if(d.getHours() == 10 && d.getMinutes() == 16){
			cal.add(Calendar.DATE, -1);
			}
			if(d.getHours() == 16 && d.getMinutes() == 11){
		...
		String subject = "Purchase Approved PO from MEPL H25 on  "+y_date+" !!!"; 
		boolean sessionDebug = false;
		// *********************************************************************************************
		// multiple recipients : == >
		// ********************************************************************************************* 
		String recipients[] = {"mahesh@muthagroup.com"};
		String cc_recipients[] = {"kunalvm@muthagroup.com","ankatariya@muthagroup.com","internalaudit@muthagroup.com","h25store@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase  Approved PO of MEPL H25 !!! ***</b>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("Aprroved Mail 12 !!!");
	}
