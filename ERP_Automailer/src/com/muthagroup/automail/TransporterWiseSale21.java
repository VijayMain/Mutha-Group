...
public class TransporterWiseSale21 extends TimerTask {

	@Override
	public void run() {
		/**************************************************************************************
		-- to pay list
		exec "ENGERP"."dbo"."Sel_TransporterWiseSale";1 '101', '0', '101021101006101003101025101019101001101014101015101008101004101009101007101002101024101005101010101016101022101011101018101023101017101013101012101020', '20150331', '20150401', N'1'
		-- paid
		exec "ENGERP"."dbo"."Sel_TransporterWiseSale";1 '101', '0', '101021101006101003101025101019101001101014101015101008101004101009101007101002101024101005101010101016101022101011101018101023101017101013101012101020', '20150331', '20150401', N'0'
		**************************************************************************************/	
		...
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 23 && d.getMinutes() == 45) {
		...
		try {
			...
			PreparedStatement pstrname=con.prepareStatement("select * from ENGERP..MSTCOMMTRANSPORT");
		...
		String subject = "MEPL H21 Transporter Wise Sale List of " + CurrentDate; 
		boolean sessionDebug = false;
		// *********************************************************************************************
		// multiple recipients : == >
		// ********************************************************************************************* 
		String recipients[] = {"ankatariya@muthagroup.com"};
		String cc_recipients[] = {"nileshss@muthagroup.com","internalaudit@muthagroup.com","h21store@muthagroup.com","jginamdar@muthagroup.com","parikshitap@muthagroup.com","marketing@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for MEPL H21 Transporter Wise Sale List !!! ***</b>"+
		...
		if(paidList_wt>0){
		sb.append("<tr style='font-size: 12px;'>"+
				"<td style='text-align: right;'  colspan='5'><b>Total &#8680;</b></td><td style='text-align: right;'>"+ pointForm.format(paidList)+"</td>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("Transport 20 !!!");
	}
