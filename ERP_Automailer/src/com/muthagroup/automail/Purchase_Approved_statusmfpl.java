...
public class Purchase_Approved_statusmfpl extends TimerTask {
	...
	public void run() {
		...
		if ((!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 17)||(!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16  && d.getMinutes() == 12)) {
		try { 
			...
			if(d.getHours() == 10 && d.getMinutes() == 17){
			cal.add(Calendar.DATE, -1);
			}
			if(d.getHours() == 16 && d.getMinutes() == 12){
		...
		String subject = "Purchase Approved PO from MFPL on  "+y_date+" !!!"; 
		boolean sessionDebug = false;
		// *********************************************************************************************
		// multiple recipients : == >
		// ********************************************************************************************* 
		String recipients[] = {"bhushan@muthagroup.com"};
		String cc_recipients[] = {"kunalvm@muthagroup.com","adgadkari@muthagroup.com","ankatariya@muthagroup.com","vijaybm@muthagroup.com","internalaudit@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase  Approved PO of MFPL !!! ***</b>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("Aprroved Mail 13 !!!");
		} 
	} 