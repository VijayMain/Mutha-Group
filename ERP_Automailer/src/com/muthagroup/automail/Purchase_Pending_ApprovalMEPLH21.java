...
public class Purchase_Pending_ApprovalMEPLH21 extends TimerTask { 
	@Override
	public void run() {
		...
		String subject = "Purchase Pending Approvals of MEPL H21 !!!"; 
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for Purchase Pending Approvals of MEPL H21 !!! ***</b>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("ERP Mailer 1");	
		} 
  }
}
