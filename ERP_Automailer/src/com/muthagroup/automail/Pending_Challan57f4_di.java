...
public class Pending_Challan57f4_di extends TimerTask {
	...
	public void run() {
		...
		try{
			...
			PreparedStatement ps_rec = conLocal.prepareStatement("select * from pending_approvee where type='to' and report='Pending_Challan57f4_DI'");
			...
			sb.append("<b style='color: #0D265E;'>This is an automatically generated email for ERP - Pending Challan 57f4 List of DI</b>");
			...
			ArrayList codes = new ArrayList();
			 PreparedStatement ps=con_DI.prepareStatement("select * from MSTACCTGLSUB where SUB_GLCODE='12'");
			...
			*/
			CallableStatement cs = con_DI.prepareCall("{call Sel_RptPendingChlnState(?,?,?,?)}");
			cs.setString(1, comp);
