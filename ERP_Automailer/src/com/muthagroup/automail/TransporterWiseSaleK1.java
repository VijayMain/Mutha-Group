...
public class TransporterWiseSaleK1 extends TimerTask {

	@Override
	public void run() {
		/**************************************************************************************
		-- To Pay List ===>
		exec "K1ERP"."dbo"."Sel_TransporterWiseSale";1 '106', '0', '101021101006101003101025101019101001101014101015101008101004101009101007101002101024101005101010101016101022101011101018101023101017101013101012101020', '20150331', '20150401', N'1'
		-- Paid ===>
		exec "K1ERP"."dbo"."Sel_TransporterWiseSale";1 '106', '0', '101021101006101003101025101019101001101014101015101008101004101009101007101002101024101005101010101016101022101011101018101023101017101013101012101020', '20150331', '20150401', N'0'
		**************************************************************************************/
		...
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 23 && d.getMinutes() == 49) {
		...
		try {
			...
			PreparedStatement pstrname=con.prepareStatement("select * from K1ERP..MSTCOMMTRANSPORT");
		...
		String cc_recipients[] = {"nileshss@muthagroup.com","internalaudit@muthagroup.com","brchourasiya@muthagroup.com","vishal@muthagroup.com","dmvhankade@muthagroup.com"};
		...
		sb.append("<b style='color: #0D265E;'>*** This is an automatically generated email for MEPL UNIT III Transporter Wise Sale List !!! ***</b>"+
	 ...
	 e.printStackTrace();
		...
		System.out.println("Transport 25 !!!"); 
	}
