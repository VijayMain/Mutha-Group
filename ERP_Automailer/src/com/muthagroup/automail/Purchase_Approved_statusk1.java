...
public class Purchase_Approved_statusk1 extends TimerTask {
	@Override
	public void run() {
		Date d = new Date();
		...
		String subject = "Purchase Approved PO from MEPL UNIT III  on  "+y_date+" !!!"; 
		...
		String cc_recipients[] = {"vijaybm@muthagroup.com","internalaudit@muthagroup.com","kunalvm@muthagroup.com","adgadkari@muthagroup.com","ankatariya@muthagroup.com"};
	 ...
	 e.printStackTrace();
		...
		System.out.println("Aprroved Mail 15 !!!");
		}  
}
