...
public class Purchase_PendDues_StatMFPL extends TimerTask {
	...
	public void run() {
		...
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 15 && d.getMinutes() == 36) {
		...
		String cc_recipients[] = {"bhushan@muthagroup.com","kunalvm@muthagroup.com","adgadkari@muthagroup.com","ankatariya@muthagroup.com","nileshss@muthagroup.com","internalaudit@muthagroup.com","govindmb@muthagroup.com"};
		...
		sb.append("<p style='font-size: 12px;'>*** This is an automatically generated alert email for Over due vendor payment of MUTHA FOUNDERS !!! ***</p>");
		 
		sb.append("<p style='font-size: 13px;'>Please find below attachment for Overdue Vendor Payment of MUTHA FOUNDERS.</p>");
		...
		// ******************************************************************************
		transport.close(); 
		System.out.println("MFPL Loop End");		
		}
			con.close();
	} catch (Exception e) {
	 e.printStackTrace();
		...
		System.out.println("Purchase Due 18 !!!");
	}
