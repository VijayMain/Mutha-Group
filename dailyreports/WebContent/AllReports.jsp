...
<span id="getReportname">
		<select name="report" id="report" style="height: 25px;background-color: #EBECED;font-family: Arial;font-size: 12px;" onchange="getAllParts(this.value)">
...
%>
<span id="getReportname"> 		
<input type="hidden" name="comphid" id="comphid" value="<%=comp%>"/>
	<select name="report" id="report" style="height: 25px;background-color: #EBECED;font-family: Arial;font-size: 12px;" onchange="getAllParts(this.value)">
	<option value=""> - - - - - - Select - - - - - - </option>
	 <%
