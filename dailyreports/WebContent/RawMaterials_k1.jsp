...
try{
	...
	//------------------------------- Date Logic --------------------------------------------------------
		...
		System.out.println("Yesterday's date K1 = "+ nowDate);	
...
<a href="RawMaterials_k1.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b style="color: green;">MEPL Unit III</b></a>&nbsp;|&nbsp;
<a href="RawMaterials_DI.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b>DI</b></a>
    </h5>
    <h6>MEPL UNIT III RAW MATERIAL REPORT &#8658;</h6>
 	...
 	<% 	
 	PreparedStatement ps = con.prepareStatement("select * from dailyreports_config_tbl where company_id=106 and reports_id=2");
 	...
 	%> 	
		...
		<%
		Connection conK1 = Connection_Util.getK1ERPConnection();
		
		// exec "FOUNDRYERPNEW"."dbo"."Sel_GRNRegister";1 '103', '0', '2025,2026', '20150601', '20150610', '103'
		boolean flag = false;
		CallableStatement cs22 = conK1.prepareCall("{call Sel_GRNRegister(?,?,?,?,?,?)}");
		cs22.setString(1,"106");
		cs22.setString(2,"0"); 
