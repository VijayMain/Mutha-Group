...
try{
	...
	//------------------------------- Date Logic --------------------------------------------------------
		...
		System.out.println("Yesterday's date FND = "+ nowDate);
...
<div id="tooplate_main">
    ...
    <a href="RawMaterials.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b style="color: green;">MFPL</b></a>&nbsp;|&nbsp;
<a href="RawMaterials_k1.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b>MEPL Unit III</b></a>&nbsp;|&nbsp;
<a href="RawMaterials_DI.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b>DI</b></a>
    </h5>
    <h6>MUTHA FOUNDERs RAW MATERIAL REPORT &#8658;</h6>
 	...
 	<% 	
 	boolean flag = false;
 	PreparedStatement ps = con.prepareStatement("select * from dailyreports_config_tbl where company_id=103 and reports_id=2");
 	ResultSet rs = ps.executeQuery();
 	while(rs.next()){
 	%> 	
        <tr align="left" style="background-color: #E3E3E3;">
			<td colspan="5" style="font-size: 11px;">&nbsp;&nbsp;&nbsp;<b style="color: blue"><%=rs.getString("matname") %> &#8658;</b></td>
		</tr>		
		<%
		Connection conFND = Connection_Util.getFoundryERPNEWConnection();		
		// exec "FOUNDRYERPNEW"."dbo"."Sel_GRNRegister";1 '103', '0', '2025,2026', '20150601', '20150610', '103'		
		CallableStatement cs22 = conFND.prepareCall("{call Sel_GRNRegister(?,?,?,?,?,?)}");
		cs22.setString(1,"103");
		cs22.setString(2,"0"); 
