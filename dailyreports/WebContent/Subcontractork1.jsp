...
<a href="Sub_ContractorStk.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b>MFPL</b></a>&nbsp;|&nbsp;
<a href="Subcontractork1.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b style="color: green;">MEPL Unit III</b></a>&nbsp;|&nbsp;
<a href="SubcontractorDI.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b>DI</b></a>
 ...
 <table class="tftable" border="1" style="width:50%;">
   ...
   Connection conerp = Connection_Util.getK1ERPConnection();
   String comp = "106";
   boolean flag = false;
   ...
   for(int i=0;i<chkName.size();i++){
	   ...
	   while(rs.next()){
		...
		while(rs_op.next()){   
			if(rs_op.getString("MAT_CODE").equalsIgnoreCase(rs.getString("matcode")) && rs_op.getString("AC_NO").equalsIgnoreCase(rs.getString("cust_code"))){
   %>
   <tr>
   <%
   if(flag==false){
