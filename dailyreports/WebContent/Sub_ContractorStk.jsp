...
<a href="SubcontractorDI.jsp" style="text-decoration: none;font-family: Arial;font-size: 14px;"><b>DI</b></a>
 ...
 <table class="tftable" border="1" style="width:50%;">
   ...
   Connection conerp = Connection_Util.getFoundryERPNEWConnection();
   String comp = "103",chk="",mat_name="",chkvalid="";
   ...
   // exec "FOUNDRYERP"."dbo"."Sel_DayWiseSubContractStockLedgerFinal";1 '103', '0' , '20160601' , '20160619'
   ...
   for(int i=0;i<chkName.size();i++){
	   ...
	   while(rs.next()){
		   ...
		   mat_name = rs.getString("matname");
		   			// System.out.println("check = " + mat_name + "  =  " + chk);
		while(rs_op.next()){
			if(rs_op.getString("MAT_CODE").equalsIgnoreCase(rs.getString("matcode")) && 
				...
				if(chk.equalsIgnoreCase(rs_op.getString("AC_NAME"))){
					// System.out.println("check 2= " + rs_op.getString("AC_NAME") + "  =  " + chk);
					...
					if(rs_op.getString("REC_QTY")!=null){
						addtq = Double.parseDouble(rs_op.getString("REC_QTY"));
						// System.out.println("DESP_QTY 22 = " + rs_op.getString("DESP_QTY"));
						balancesum = balancesum + Double.parseDouble(rs_op.getString("DESP_QTY"));
					}
				}
			}
