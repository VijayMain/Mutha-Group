...
public class ComplaintZilla_alertdi extends TimerTask {
	...
	public void run() {
		...
		/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 33) {*/
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 36) {
		//************************************************************************************************				
		try{  
