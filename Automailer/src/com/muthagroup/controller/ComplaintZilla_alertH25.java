...
public class ComplaintZilla_alertH25 extends TimerTask {
	...
	public void run() {
		...
		/*if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 10 && d.getMinutes() == 31) {*/
		if (!weekday[d.getDay()].equals("Tuesday") && d.getHours() == 16 && d.getMinutes() == 34) {
		//************************************************************************************************				
		try{  
