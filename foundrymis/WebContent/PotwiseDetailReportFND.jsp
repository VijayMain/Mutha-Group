...
<title>POTWISE Details Founders</title>
<style type="text/css">
.tftable {
	font-size: 10px;
	font-family: Arial; 
...
<strong style="font-family: Arial;font-size: 14px;"><a href="PotwiseReportFND.jsp?comp=<%=comp %>&datefrom=<%=datefrom %>&dateto=<%= dateto%>&db=<%=db %>&code=652" style="text-decoration: none;">&lArr;BACK</a></strong>
<% 
	int srno=1; 
 ...
 %>  
			<table border="1" class="tftable" style="width: 40%"> 
				...
				%>
				<tr align="center" style="background-color: #FEFCFF;cursor: pointer;" align="center">
