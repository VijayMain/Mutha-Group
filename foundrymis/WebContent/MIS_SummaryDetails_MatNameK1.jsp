...
<title>Detailed MIS ItemWise K-1</title>
</head>
...
<body bgcolor="#EBE4E7" style="font-family: Arial;">
	...
	<strong>MUTHA ENGINEERING PVT.LTD.UNIT III<br /> </strong>
<strong style="font-family: Arial;font-size: 14px;"><a href="MIS_SummaryDetails_GradeK1.jsp?comp=<%=comp %>&ondate=<%=OnDateMIS %>&db=<%=db %>&grade=<%=grade %>" style="color:blue; text-decoration: none;">&lArr;BACK</a></strong>
<br/>
	<div style="width: 50%; padding-left: 1em; float: left;"> 
		<table border="1" class="tftable">
			<tr>
				<th scope="col" align="center" colspan="2"><strong><%=item %></strong></th> 
			</tr>
		<tr>
