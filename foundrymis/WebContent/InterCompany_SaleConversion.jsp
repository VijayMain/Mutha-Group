...
<script type="text/javascript">
	function getprev_Details(str,str2,unit) {
		...
		xmlhttp.open("POST", "InterCompany_SalePrev.jsp?FromDate_ICS=" + str+"&ToDate_ICS="+str2+"&unitConvert="+unit, true);
		xmlhttp.send();
	};
	/* 
...
String unitConvert = request.getParameter("unitConvert"); 
System.out.println("Testing = " + from_date + "\n" + to_date+" Unit  = " +unitConvert); 
...
int	unit=Integer.parseInt(unitConvert); 
String rec="";
if(unit==1){
	rec = "Rupees";
}else{
...
<table  border="1" class="tftable"> 
			<tr>
				<td align="center" scope="col" colspan="7"><strong style="font-size: 14px;font-family: Arial;">Sister Company Sale From  <%=dateFrom %> to <%=dateTo %></strong>&nbsp;<strong style="color: green;font-size: 10px;">all in <%=rec %></strong>    </td> 
			</tr>
			<tr style="font-family: Arial;">
				...
				<th align="center" scope="col" width="18%"><strong>Total</strong></th>  
			</tr>
				...
				ResultSet rs_H21_toH25 = H21_toH25.executeQuery();
				 ...
				 for(int i = 0; i < listH21_ToH25.size(); i++)
				  {
					 sumH21_ToH25 += (Double.parseDouble(listH21_ToH25.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_H21_tomfpl = H21_tomfpl.executeQuery();
				 ...
				 for(int i = 0; i < listH21_Tomfpl.size(); i++)
				  {
					 sumH21_Tomfpl += (Double.parseDouble(listH21_Tomfpl.get(i).toString())/unit);
				  }   
				...
				ResultSet rs_H21_todi = H21_todi.executeQuery();
				 ...
				 for(int i = 0; i < listH21_Todi.size(); i++)
				  {
					 sumH21_Todi += (Double.parseDouble(listH21_Todi.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_H21_tounitIII = H21_tounitIII.executeQuery();
				 ...
				 for(int i = 0; i < listH21_TounitIII.size(); i++)
				  {
					 sumH21_TounitIII += (Double.parseDouble(listH21_TounitIII.get(i).toString())/unit);
				  } 		
		...
		<!-- ******************************************************************************************************************** -->
				...
				ResultSet rs_H25_toH21 = H25_toH21.executeQuery();
				 ...
				 for(int i = 0; i < listH25_toH21.size(); i++)
				  {
					 sumH25_ToH21 += (Double.parseDouble(listH25_toH21.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_H25_tomfpl = H25_tomfpl.executeQuery();
				 ...
				 for(int i = 0; i < listH25_tomfpl.size(); i++)
				  {
					 sumH25_Tomfpl += (Double.parseDouble(listH25_tomfpl.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_H25_todi = H25_todi.executeQuery();
				 ...
				 for(int i = 0; i < listH25_todi.size(); i++)
				  {
					 sumH25_Todi += (Double.parseDouble(listH25_todi.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_H25_tok1 = H25_tok1.executeQuery();
				 ...
				 for(int i = 0; i < listH25_tok1.size(); i++)
				  {
					 sumH25_Tok1 += (Double.parseDouble(listH25_tok1.get(i).toString())/unit);
				  } 
			...
			<tr>
				...
				<td align="right"><a href="InterCompany_SaleDetails.jsp?comp=102&reportof=H25_toH21&fromDate=<%=from_date %>&toDate=<%=to_date %>" style="color: black;" title="Click to get Details"><strong><%=mytotals.format(sumH25_ToH21) %></strong> </a> </td>
				<td align="right" style="background-color: #ED723E;"></td>
		...
		<!-- ******************************************************************************************************************** -->	
				...
				ResultSet rs_mfpl_toH21 = mfpl_toH21.executeQuery();
				 ...
				 for(int i = 0; i < listmfpl_toH21.size(); i++)
				  {
					 summfpl_ToH21 += (Double.parseDouble(listmfpl_toH21.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_mfpl_toH25 = mfpl_toH25.executeQuery();
				 ...
				 for(int i = 0; i < listmfpl_toH25.size(); i++)
				  {
					 summfpl_ToH25 += (Double.parseDouble(listmfpl_toH25.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_mfpl_todi = mfpl_todi.executeQuery();
				 ...
				 for(int i = 0; i < listmfpl_todi.size(); i++)
				  {
					 summfpl_Todi += (Double.parseDouble(listmfpl_todi.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_mfpl_tounitIII = mfpl_tounitIII.executeQuery();
				 ...
				 for(int i = 0; i < listmfpl_tounitIII.size(); i++)
				  {
					 summfpl_TounitIII += (Double.parseDouble(listmfpl_tounitIII.get(i).toString())/unit);
				  } 
			...
			<tr>
				...
				<td align="right"><a href="InterCompany_SaleDetails.jsp?comp=103&reportof=mfpl_toH21&fromDate=<%=from_date %>&toDate=<%=to_date %>" style="color: black;" title="Click to get Details"><strong><%=mytotals.format(summfpl_ToH21) %></strong> </a> </td>
		...
		<!-- ******************************************************************************************************************** -->
				...
				ResultSet rs_di_toH21 = di_toH21.executeQuery();
				 ...
				 for(int i = 0; i < listdi_toH21.size(); i++)
				  {
					 sumdi_toH21 += (Double.parseDouble(listdi_toH21.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_di_toH25 = di_toH25.executeQuery();
				 ...
				 for(int i = 0; i < listdi_toH25.size(); i++)
				  {
					 sumdi_toH25 += (Double.parseDouble(listdi_toH25.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_di_tomfpl = di_tomfpl.executeQuery();
				 ...
				 for(int i = 0; i < listdi_tomfpl.size(); i++)
				  {
					 sumdi_tomfpl += (Double.parseDouble(listdi_tomfpl.get(i).toString())/unit);
				  } 
				...
				ResultSet rs_di_tounitIII = di_tounitIII.executeQuery();
				 ...
				 for(int i = 0; i < listdi_tounitIII.size(); i++)
				  {
					 sumdi_tounitIII += (Double.parseDouble(listdi_tounitIII.get(i).toString())/unit);
				  } 
			...
			<tr>
				...
				<td align="right"><a href="InterCompany_SaleDetails.jsp?comp=105&reportof=di_toH21&fromDate=<%=from_date %>&toDate=<%=to_date %>" style="color: black;" title="Click to get Details"><strong><%=mytotals.format(sumdi_toH21) %></strong> </a> </td>
		...
		<!-- ******************************************************************************************************************** -->	
				...
				ResultSet rs_k1_toH21 = k1_toH21.executeQuery();
				 ...
				 for(int i = 0; i < listk1_ToH21.size(); i++)
				  {
				 	sumk1_ToH21 += (Double.parseDouble(listk1_ToH21.get(i).toString())/unit);
				  }  
				...
				ResultSet rs_k1_toH25 = k1_toH25.executeQuery();
				 ...
				 for(int i = 0; i < listk1_ToH25.size(); i++)
				  {
				 	sumk1_ToH25 += (Double.parseDouble(listk1_ToH25.get(i).toString())/unit);
				  }  
				...
				ResultSet rs_k1_tomfpl = k1_tomfpl.executeQuery();
				 ...
				 for(int i = 0; i < listk1_Tomfpl.size(); i++)
				  {
				 	sumk1_Tomfpl += (Double.parseDouble(listk1_Tomfpl.get(i).toString())/unit);
				  }  
				double sumk1_Todi = 0;	  
				...
				ResultSet rs_k1_todi = k1_todi.executeQuery();
				 ...
				 for(int i = 0; i < listk1_Todi.size(); i++)
				  {
				 	sumk1_Todi += (Double.parseDouble(listk1_Todi.get(i).toString())/unit);
				  }
			...
			<tr>
				...
				<td align="right"><a href="InterCompany_SaleDetails.jsp?comp=106&reportof=k1_toH21&fromDate=<%=from_date %>&toDate=<%=to_date %>" style="color: black;" title="Click to get Details"><strong><%=mytotals.format(sumk1_ToH21) %></strong> </a> </td>
...
%>
<button style="height: 30px;" onclick="getprev_Details('<%=fromprev%>','<%=toprev%>',<%=unit%>)"><strong>Get Last Year Sale</strong></button>
