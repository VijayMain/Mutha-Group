...
try {
    ...
    Label labelHeading = new Label(0, 0, CompanyName + " Day wise Production For The Month " + monthName , cellFormat);
...
//***********************************************************************************************************
    ...
    Label label3 = new Label(3, 1, "Prod Plan Qty",cellFormat);
    Label label4 = new Label(4, 1, "Prod Plan Per Day",cellFormat);
    Label label5 = new Label(5, 1, "Actual Per Day",cellFormat);
	...
	while (rs122.next()) {
		if(ct==""){ 
			  ...
			  Label la0 = new Label(l, r, String.valueOf(srno) ,cellFormat);
			   ...
			   l++; 
			   Label la3 = new Label(l, r, rs122.getString("PLAN_QTY"),cellRIghtformat);
			   writableSheet.addCell(la3);
			   l++; 
			   Label la4 = new Label(l, r, rs122.getString("PARDAY_QTY"),cellRIghtformat);
