...
<body bgcolor="#DEDEDE" style="font-family: Arial;">
	...
	%>
	<div>
<strong style="font-family: Arial;font-size: 14px;">DHANASHREE INDUSTRIES&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span style="font-family: Arial;font-size: 13px;">Please Note :<strong style="color: red;">&nbsp;&nbsp;*</strong> means Earlier day's production</span> 
		...
		<div class="div_freezepanes_wrapper">
			...
			%>
				<tr  onmouseover="this.style.background='#EEEEEE';" onmouseout="this.style.background='';">
					<td class="td1" align="center" width="1%"><%=ct %></td>
					<td class="td1" align="left" width="20%"><%= rs1.getString("MAT_NAME") %></td>
					<td class="td1" align="right" width="2%"><b style="color: red;">*</b> <%=oneDForm.format(Double.parseDouble(rs1.getString("PrevPouredQTY"))) %></td>
