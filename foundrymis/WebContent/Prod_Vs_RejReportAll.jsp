...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
<strong style="color: #1B5869;font-family: Arial;font-size: 14px;">Production Vs. Rejection Report for all Grades from <%=Dispdate_From%> to <%=Dispdate_To%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
...
<strong style="font-family: Arial;font-size: 13px;"><a href="HomePage.jsp" style="text-decoration: none;">&lArr;BACK</a></strong>
		...
		<div class="div_freezepanes_wrapper">
			...
			<td class="td1" align="right"><%=mytotals.format(Double.parseDouble(rs1.getString("TOTAL_WT"))/1000)%></td>
			...
			<td nowrap class="td1" align="right" width="2%"><%=myFormatter.format(Double.parseDouble(rs1.getString("INV_QTY"))) %></td>		
			<td nowrap class="td1" align="center" width="2%"><%=twoDForm.format(Double.parseDouble(rs1.getString("INV_WEIGHT"))/1000)  %></td>
			<%
			rrWt =0;
			rejper=0;
...
//				Good cast qty = poured qty - ( fl qty + SB Qty )
			...
			<td class="td1" align="right"><%=twoDForm.format(rrWt/1000) %>  </td>
			<td class="td1" align="right"><%=zeroDForm.format(Double.parseDouble(rs1.getString("FLOOR_QTY"))) %></td>
			<td class="td1" align="right"><%=zeroDForm.format(Double.parseDouble(rs1.getString("SHOTBLASTED_QTY"))) %></td>
			<td class="td1" align="right"><%=twoDForm.format(Double.parseDouble(rs1.getString("WEIGHT"))/1000) %></td>
			<td class="td1" align="right"><%=twoDForm.format(rejper)%></td>
			...
			<tr> 
					...
					<td nowrap class="td1" align="right" width="2%"><strong><%=myFormatter.format(total_invoiceQty) %></strong> </td>		
					<td nowrap class="td1" align="center" width="2%"><strong><%=mytotals.format(total_invoicewtQty/1000) %></strong> </td>
					<th></th>							
				</tr>
			</table>			
		</div>
		...
		-->
		 ...
		 %>
		  ...
		  <table border="1" class="tftable" style="width: 100%">  	 
				...
				<tr>
					<td style="font-size: 12px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center; height: 5px;"><strong> <%=mytotals.format(total_moltenMetalQty/1000) %> </strong> </td>
				 	<td style="font-size: 12px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center; height: 5px;"><strong> <%=mytotals.format(total_castingwtTotalQty/1000) %> </strong> </td>
				 	<td style="font-size: 12px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center; height: 5px;"><strong> <%=mytotals.format(total_rrwtQty/1000) %> </strong> </td>
				 	<td style="font-size: 12px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center; height: 5px;"><strong> <%=mytotals.format(total_rejwtQty/1000) %> </strong> </td>
				 	<td style="font-size: 12px; border-width: 1px; padding: 8px; border-style: solid; border-color: #729ea5; text-align: center; height: 5px;"><strong> <%=mytotals.format(total_goodcastwtQty/1000) %> </strong> </td>
				</tr>				 
			</table>
		  </div>	  
