...
<title>POTWISE Details DI</title>
<style type="text/css">
.tftable {
	font-size: 10px;
	font-family: Arial; 
...
<br/> 
<strong style="font-family: Arial;font-size: 14px;"><a href="PotwiseReportDI.jsp?comp=<%=comp %>&datefrom=<%=datefrom %>&dateto=<%= dateto%>&db=<%=db %>&code=652" style="text-decoration: none;">&lArr;BACK</a></strong>
<% 
	int srno=1; 
