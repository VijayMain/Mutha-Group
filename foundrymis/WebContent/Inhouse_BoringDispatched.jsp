...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
<strong style="color: #1B5869;font-family: Arial;font-size: 14px;">In-house Dispatch of <%=filter%> <%=month %>&nbsp;<%=year %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><br/>
<br/>
...
int sr=1;
CallableStatement csdes = con.prepareCall("{call Sel_SaleRegister(?,?,?,?,?,?)}");
...
csdes.setString(6,"0");
ResultSet rs = csdes.executeQuery(); 
	%>
<!--============================================================================-->
<!--============================================================================-->
		<table border="1" class="tftable">
				...
				<tr>
					...
					<td align="left" width="55%"><%=rs.getString("CUSTOMER_NAME") %></td>
					<td align="right"><%=rs.getString("PRN_TRANDATE") %></td>
					<td align="right"><%=rs.getString("INV_NO") %></td> 
					<td align="right" width="10%"><%=zeroDForm.format(Double.parseDouble(rs.getString("QTY"))) %></td>
				</tr>
				<%
				sr++;
					} 
