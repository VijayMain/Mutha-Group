...
try {
	...
	Label ReportName = new Label(0, 0, CompanyName + " MIS Summary Report " + OnDate + "       (Total Working Days : " + count_mnt + " and Working Days Over : " + total_dd + ")",cellFormat_header);
	...
	Label label6 = new Label(2, 2, "SGI",cellFormat);
	...
	Label label9 = new Label(5, 2, "SGI",cellFormat);
	...
	for(int i=0;i<10;i++){
		   ...
		   l++;
		   Label la2 = new Label(l, r, sg.get(i).toString(),cellRIghtformat);
		   l++; 
		   ...
		   writableSheet.addCell(la2);
			...
			if(i==2){
				...
				Label la3 = new Label(l, r, zeroDForm.format(yield),cellRIghtformat);
				   ...
				   l++;
				   Label la5 = new Label(l, r, sg.get(j).toString(),cellRIghtformat);
				   l++;
	...
	cs_heat.setString(6, "K1ERP");
	cs_heat.setString(7, "K1FMSHOP");
	...
	cs_ondate.setString(6, "K1ERP");
	cs_ondate.setString(7, "K1FMSHOP");
	...
	int total_average = total_sgi/workdays;
	   ...
	   l++;
	   Label la5 = new Label(l, r, String.valueOf(todatesgi.size()),cellRIghtformat);
	   l++;
	   Label la6 = new Label(l, r, String.valueOf(total_sgi),cellRIghtformat);
	   l++;
