...
<title>Sale Return Founders</title>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
<strong style="color: #1B5869;font-family: Arial;font-size: 14px;">Day wise Customer Return For The Month  <%=monthName %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><br/>
...
%> 
			<table id="t1" border="1" cellpadding=2 style="border: 1px solid #000;"> 
				...
				<tr onmouseover="this.style.background='#EEEEEE';" onmouseout="this.style.background='';" >
					...
					<td class="td1" align="right"><%=rs122.getString("CR_PER")  %> </td>
					<td class="td1" align="right"><%=rs122.getString("CR_PERCENT")  %> </td>
					<td class="td1" align="right"><%=rs122.getString("TOT_SALEQTY")  %> </td>
