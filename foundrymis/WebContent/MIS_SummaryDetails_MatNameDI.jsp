...
<title>Detailed MIS ItemWise DI</title>
</head>
...
<body bgcolor="#EBE4E7" style="font-family: Arial;">
	<%
		...
		%> 
<strong style="font-family: Arial;font-size: 14px;">DHANASHREE INDUSTRIES<br/>
<strong style="font-family: Arial;font-size: 14px;"><a href="MIS_SummaryDetails_GradeDI.jsp?comp=<%=comp %>&ondate=<%=OnDateMIS %>&db=<%=db %>&grade=<%=grade %>" style="color:blue; text-decoration: none;">&lArr;BACK</a></strong><br/>
</strong>
