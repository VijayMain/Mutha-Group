...
<body>
	...
	<form action="take_action_controller" name="Req_Reopen" id="Req_Reopen" method="post">	
  		<table align="center" border="0" class="tftable">
  			<tr>
				...
				<%
					...
					{
						status=rs_reqDetails.getString("Status");
				...
				<tr>
					...
					<% 
						...
						{
					%>
					<input type="hidden" name="done_by" value="<%=rs_user.getString("U_Name")%>">
  				...
  				<td colspan="5" align="left">
  					<select name="status" style="height: 30px;width: 90px;font-size: 14px;">
 				...
 				<tr>
  				...
  				<tr> 
  				<td align="right"><a href="Closed_Req_User.jsp"><font style="font-size: 15px; color: blue;">&#8656; Go Back</font></a></td>
  					<td colspan="5" align="left"><input type="submit" value="Reopen Requisition" style="width: 150px; height: 30px;"></td>
  					</tr>
  		</table>
</form>
