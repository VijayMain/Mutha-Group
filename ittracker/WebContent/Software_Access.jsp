...
<body>
	<div id="container">
		...
		<%@page import="java.sql.PreparedStatement"%>
<div style="height: 450px;width:99%; overflow: scroll;">  
		<form action="software_access_controller" method="post" id="myForm"
			name="myForm" onsubmit="return(validate());"> 
 <br>
				<table align="center">
					<thead>
						<tr>
							<td align="left" colspan="2"><a href="User_List.jsp"><b style="color: green;background-color: #E1F3F5;">&#8658;&#8658; TO GET ACCESS CONTROL OF ALL USERS CLICK HERE &#8656; &#8656; </b></a></td> 
						</tr> 
						<tr>
							<td align="left"><b>Software Access To Particular User :</b></td>
						...
						<tr>
							<td colspan="1" align="left"><select id="software_name"
								...
								onfocus="if (this.innerHTML == '') {this.innerHTML = '';}"> 
									<%
										PreparedStatement ps_soft = con
													.prepareStatement("select * from It_Software_Tbl");
