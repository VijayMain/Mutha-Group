...
int sheet_no = 0;
	...
	String new_part_name=null;
	String new_part_no=null;
	String new_grade_type=null;
	String new_plant_vendor=null;
	String new_casting_vendor=null;
	...
	public String getNew_grade_type() {
		return new_grade_type;
	}
	public void setNew_grade_type(String new_grade_type) {
		this.new_grade_type = new_grade_type;
	}
	public String getNew_plant_vendor() {
		return new_plant_vendor;
	}
	public void setNew_plant_vendor(String new_plant_vendor) {
		this.new_plant_vendor = new_plant_vendor;
	}
	public String getNew_casting_vendor() {
		return new_casting_vendor;
	}
	public void setNew_casting_vendor(String new_casting_vendor) {
		this.new_casting_vendor = new_casting_vendor;
	}
