...
import com.muthagroup.bo.Add_Batch_bo;
...
public class Add_Batch_controller extends HttpServlet {	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		Add_Batch_vo vo=new Add_Batch_vo();
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			...
			try {
				...
				Add_Batch_bo bo=new Add_Batch_bo();
				
				flag=bo.addBatch(vo,request);
			}catch(Exception e)
			{
				e.printStackTrace();
			}
