...
import com.muthagroup.bo.Add_Others_bo;
import com.muthagroup.vo.Add_Others_vo;

public class Add_Others_Controller extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		Add_Others_vo vo=new Add_Others_vo();
		...
		Add_Others_bo bo=new Add_Others_bo();
		
		flag=bo.addOthers(vo,request);
