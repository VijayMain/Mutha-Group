...
<body>
	<%
		try {
			...
			int nameString = Integer
					.parseInt(request.getParameter("field"));
			...
			PreparedStatement ps = con
					.prepareStatement("select * from dev_basicinfo_po_attachment_tbl where BI_PO_Attach_Id="
							+ nameString);
			...
			if (rs.next()) {
				...
				String headerValue = String.format(
						"attachment; filename=\"%s\"",rs.getString("File_Name"));
