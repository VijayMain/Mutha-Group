 ...
 -->
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<a href="Add_Category.jsp" id="company-branding-small" class="fr"><img
		...
		<div class="page-full-width cf">
			...
			<div class="side-content fr">
				 ...
				 ********************************************************************
								...
								Actual Form Content to add the new Category				
				 ...
				 -->
						...
						<div id="form_container">
							...
							<form class="appnitro" method="post"
								action="Add_Category_Controller">
								...
								<ul>
									...
									<li id="li_1"><label class="description" for="element_1">Enter
											new Category</label>
										<div>
											<input id="element_1" name="catagory_name"
												class="element text medium" type="text" maxlength="255"
												value="" />
										</div></li>


									<li id="li_1"><label class="description" for="element_1">Initials
											for category(if any)</label>
										<div>
											<input id="element_1" name="cat_init"
												class="element text medium" type="text" maxlength="255"
												value="" />
										</div></li>
