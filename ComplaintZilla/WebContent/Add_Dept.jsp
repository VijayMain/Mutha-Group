		...
		<div class="page-full-width cf">
			...
			<div class="side-content fr">
				 ...
				 ********************************************************************
							...
							Actual Form Content to add new Department name
				...
				**************************************************************************
				 -->
						...
						<div id="form_container">
							...
							<form class="appnitro" method="post" action="Add_Dept_Controller">
								...
								<ul>
									...
									<li id="li_1"><label class="description" for="element_1">Enter
										...
										<div>
											<input id="element_1" name="Department"
