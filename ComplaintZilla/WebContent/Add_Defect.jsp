 ...
 -->
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<a href="Add_Defect.jsp" id="company-branding-small" class="fr"><img
		...
		<div class="page-full-width cf">
			...
			<div class="side-content fr">
				 ...
				 ********************************************************************
								...
								Actual Form Content	to add the new Defect to List			
							...
							<form class="appnitro" method="post"
								...
								<ul>
									...
									<li id="li_1"><label class="description" for="element_1">Enter
											new defect</label>
										<div>
											<input id="element_1" name="defect"
