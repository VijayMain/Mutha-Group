...
SCRIPT TO TAKE ACTION
	...
	<SCRIPT LANGUAGE="JavaScript">
		function button1(val) {
			var val1 = val;
			//var conf = confirm("Do you really want to take action on " + val1);
			//if (conf == true) {
	...
	<div id="content">
		...
		return conv;
									...
									<%
										//*************************************************************************************************************************
											// CODE FOR PAGINATION 
											Connection conn = Connection_Utility.getConnection();
											...
											String sqlPagination = "SELECT SQL_CALC_FOUND_ROWS *,CONVERT(SUBSTRING(Complaint_No, 12, 100),Unsigned Integer) as C_No FROM Complaint_Tbl where Status_id=1 order by C_No desc limit "
													+ iPageNo + "," + iShowRows + "";
											...
											<tr>
												<td colspan="3">
													<div>
														...
														%>
														<a
															href="All_Complaint_Others.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>">
															Previous</a>
														<%
															}
														...
														%>
														<a href="All_Complaint_Others.jsp?iPageNo=<%=i%>"
															style="cursor: pointer; color: red"><b><%=i%></b></a>
														<%
															} else if (i <= iTotalPages) {
														%>
														<a href="All_Complaint_Others.jsp?iPageNo=<%=i%>"><%=i%></a>
														<%
															}
																	}
														...
														%>
														<a
															href="All_Complaint_Others.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>">
															Next</a>
														<%
															}
																}
