...
<title>Unassigned DI Complaints</title>
									...
									<form name="frm">
										...
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<thead>
												...
												<tr>
													<th width="20%"><a
														href="Unassigned_DI.jsp?name=unassign_id"
														style="color: white;">Sr. No</a></th>
													<th><a href="Unassigned_DI.jsp?name=Mail_From"
														style="color: white;"> Mail From</a></th>



													<th><a href="Unassigned_DI.jsp?name=Mail_Subject"
														style="color: white;">Mail Subject</a></th>


													<th width="30%"><a
														href="Unassigned_DI.jsp?name=Mail_Received_Date"
														style="color: white;"> Mail Received Date</a></th>


													<th><a href="Unassigned_DI.jsp?name=Company_Name"
											...
											<tr>
												<td colspan="3">
													<div>
														...
														%>
														<a
															href="Unassigned_DI.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>">
															Previous</a>
														<%
															}
														...
														%>
														<a href="Unassigned_DI.jsp?iPageNo=<%=i%>"
															style="cursor: pointer; color: red"><b><%=i%></b></a>
														<%
															} else if (i <= iTotalPages) {
														%>
														<a href="Unassigned_DI.jsp?iPageNo=<%=i%>"><%=i%></a>
														<%
															}
																	}
																	if (iTotalPages > iTotalSearchRecords && i < iTotalPages) {
														%>
														<a href="Unassigned_DI.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>">
															Next</a>
														<%
															}
																}
