...
<body> 
	...
	<!-- <div class="content-module-heading cf">
		<h3 class="fl">Generate Report</h3> </div> -->
...
<tr style="font-size: 15px;"> 
  ...
  <tr align="center" style="cursor: pointer;">
    <th><b>MEPL H21</b></th>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=1&status=1"><%=h21_comp.get(0) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=1&status=2"><%=h21_comp.get(1) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=1&status=3"><%=h21_comp.get(2) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=1&status=4"><%=h21_comp.get(3) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=1&status=5"><%=h21_comp.get(4) %></a></td>
  </tr>
  <tr align="center" style="cursor: pointer;">
    <th><b>MEPL H25</b></th>
      <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=2&status=1"><%=h25_comp.get(0) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=2&status=2"><%=h25_comp.get(1) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=2&status=3"><%=h25_comp.get(2) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=2&status=4"><%=h25_comp.get(3) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=2&status=5"><%=h25_comp.get(4) %></a></td>
  </tr>
  <tr align="center" style="cursor: pointer;">
    <th><b>MFPL</b></th>
	<td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=3&status=1"><%=mfpl_comp.get(0) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=3&status=2"><%=mfpl_comp.get(1) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=3&status=3"><%=mfpl_comp.get(2) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=3&status=4"><%=mfpl_comp.get(3) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=3&status=5"><%=mfpl_comp.get(4) %></a></td>
  </tr>
  <tr align="center" style="cursor: pointer;">
    <th><b>DI</b></th>
   	<td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=5&status=1"><%=di_comp.get(0) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=5&status=2"><%=di_comp.get(1) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=5&status=3"><%=di_comp.get(2) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=5&status=4"><%=di_comp.get(3) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=5&status=5"><%=di_comp.get(4) %></a></td>
  </tr>
  <tr align="center" style="cursor: pointer;">
    <th><b>MEPL UNIT III</b></th>
  	<td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=4&status=1"><%=unit3_comp.get(0) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=4&status=2"><%=unit3_comp.get(1) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=4&status=3"><%=unit3_comp.get(2) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=4&status=4"><%=unit3_comp.get(3) %></a></td>
    <td style="background-color: #F2F2F2;font-size: 14px;"><a href="Dashboard_Summary.jsp?comp=4&status=5"><%=unit3_comp.get(4) %></a></td>
  </tr>
