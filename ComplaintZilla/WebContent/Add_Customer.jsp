 ...
 -->
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<a href="Add_Customer.jsp" id="company-branding-small" class="fr"><img
		...
		<div class="page-full-width cf">
			...
			<div class="side-content fr">
				 ...
				 ********************************************************************
								...
								Actual Form Content	to add the new Customer to List			
				...
				**************************************************************************
				 -->
					...
					<div id="form_container">
						...
						<form class="appnitro" method="post"
							action="Add_Customer_Controller">
				 ...
				 ********************************************************************
							     ...
							     Get the drop down list of Company		
				...
				**************************************************************************
				 -->
								...
								<li id="li_1"><label class="description" for="element_1">Enter
										Customer Name</label>
									<div>
										<input id="element_1" name="customer_name"
											class="element text medium" type="text" maxlength="255"
											value="" />
									</div></li>


								<li id="li_1"><label class="description" for="element_1">Email
										Id</label>
									<div>
										<input id="element_1" name="customer_email"
											class="element text medium" type="text" maxlength="255"
											value="" />
									</div></li>
