...
<body>
	...
	<%@ page import="com.muthagroup.vo.Edit_By_Search_Others_VO"%>
	<%@page import="com.muthagroup.connectionModel.Connection_Utility"%>
	<%@ page import="java.util.ArrayList"%>
	<%
	try {
		GetUserName_BO ubo = new GetUserName_BO();
		Edit_By_Search_Others_VO bean = null;
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<a href="http://localhost:8001/ComplaintZilla/Home.jsp"
		...
		<div class="page-full-width cf">
			...
			<!-- <div class="side-content fr">
				...
				<div class="content-module"> -->
					...
					<div class="content-module-main" style="overflow: scroll;height: 550px;">
						...
						<input type="hidden" name="hid" id="hid">
							<table style="width: 100%;" class="tftable">
												<tr>
													...
													<th style="width: 60px;"><b>Type</b></th>
													<th><b>Cust Name</b></th>
													<th><b>Company</b></th>
													<th><b>Status</b></th>
													<th><b>Severity</b></th>
							...
							query="select * from complaint_tbl where complaint_no='" + complaint_no + "'";
							 ...
							 %>
							 	<tr onmouseover="ChangeColor(this, true);" onmouseout="ChangeColor(this, false);" onclick="button1('<%=rs_sel.getString("complaint_no")%>');" style="cursor: pointer;">
												...
												<%
															...
															PreparedStatement ps_registerer = con.prepareStatement("select U_Name from User_tbl where U_id="
																			+ rs_sel.getInt("U_Id"));
															...
															PreparedStatement ps_assigned = con.prepareStatement("select U_Name from User_tbl where U_id="
																			+ rs_sel.getInt("Complaint_Assigned_To"));
