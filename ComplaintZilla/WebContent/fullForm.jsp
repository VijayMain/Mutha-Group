	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="page-full-width.html" class="active-tab">Full
						width page</a></li>
		...
		<div class="page-full-width cf">
			...
			<div class="content-module">
				...
				<div class="content-module-main">
					...
					<p>
						This is a page that spans the entire available space. You can use
						this as an alternative to the two-column layout that you saw in <a
							href="dashboard.html">the dashboard page</a>.
					</p>

					<p>Here's what a table looks like when spanned the entire
						width.</p>
					...
					<p>When you resize the page, all the elements inside the page
						will resize as well, this being a liquid or fluid layout.</p>
