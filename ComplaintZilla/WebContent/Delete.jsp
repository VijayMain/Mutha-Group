...
<body>
	<%
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("update complaint_tbl_attachments set delete_Status=0 where Attach_Id="
							+ id);
			ps.executeUpdate();

			PreparedStatement ps_sel = con
					.prepareStatement("select * from complaint_tbl_attachments where Attach_Id="
							+ id);
