...
public class Edit_By_Search_Others_DAO {
	int n = 0;
	...
	public void editBySearch(Edit_By_Search_Others_VO bean,
		...
		try {
			...
			if (bean.getComplaint_no() == "") {
				...
				// Search when two dates and status_id are available
				...
				// Search when only status_id is available
				...
				// earch when only company_id and status_id are available
				...
				// Search when customer name and two dates and status_id are
				// available
				...
				// Search when customer name and status_id are available
				...
				// Search when customer name and status_id and company_id are
				// available
				...
				// Search when customer name and status_id and date1 are
				// available
				...
				// Search when customer name and status_id and date2 are
				// available
				...
				// Search when status_id and date2 are available
				...
				// Search when status_id and date1 are available
				...
				// Search when company_id and status_id and date1 are available
				...
				// Search when company_id and date1 and date2 and status_id are
				// available
				...
				// ************************************************************************************
				// Search when Customer ,Severity and Status
				// ************************************************************************************

				else if (cust_id != 0 && severity != 0 && status_id != 0
						&& date1 == null && date2 == null && company_id == 0) {
					ps = con.prepareStatement("select * from complaint_tbl where Cust_Id="
							+ cust_id
							+ " and P_Id="
							+ severity
							+ " and Status_Id=" + status_id);
				...
				// ************************************************************************************
				// Search when Severity and Status
				// ************************************************************************************
			...
			RequestDispatcher rd = request
					.getRequestDispatcher("/Search_Result_Others.jsp");
