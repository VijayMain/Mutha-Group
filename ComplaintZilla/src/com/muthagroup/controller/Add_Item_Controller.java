...
public class Add_Item_Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			if (!request.getParameter("cust_name").equals("")
					&& !request.getParameter("iten_name").equals("")) {

				index_vo.setCustomer_id(Integer.parseInt(request
						.getParameter("cust_name")));
				index_vo.setIten_name(request.getParameter("iten_name"));
