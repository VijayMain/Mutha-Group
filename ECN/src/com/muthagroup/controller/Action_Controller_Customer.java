...
import com.muthagroup.bo.Action_Customer_BO;
...
public class Action_Controller_Customer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			Action_Customer_VO bean = new Action_Customer_VO();
			Action_Customer_DAO dao = new Action_Customer_DAO();
			Action_Customer_BO bo = new Action_Customer_BO();
			...
			if (ServletFileUpload.isMultipartContent(request)) {
				...
				try {
					...
					if (Transfer.equalsIgnoreCase("1")) {
						...
						response.sendRedirect("Cab_Home_Customer.jsp");
						...
						response.sendRedirect("Add_Action_Details_Customer.jsp?hid="
								+ crno);
					} else if (Transfer.equalsIgnoreCase("4")) {
