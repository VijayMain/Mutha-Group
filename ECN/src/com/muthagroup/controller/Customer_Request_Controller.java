					...
					while (it.hasNext()) {
						...
						if (fileItemTemp.isFormField()) {
							...
							if (fieldName.equalsIgnoreCase("extchg")) {
								...
								//System.out.println(bean.getExisting_Change_level());
							}
							if (fieldName.equalsIgnoreCase("extchgdate")) {
								...
								if (val.equalsIgnoreCase("") || val.equalsIgnoreCase(null)) { 
									...
									bean.setExisting_Change_level_Date(tim);
								} else {
									SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
							...
							if (fieldName.equalsIgnoreCase("newchgdate")) { 
								...
								if (val.equalsIgnoreCase("") || val.equalsIgnoreCase(null)) { 
									...
									final java.sql.Date Date12 = new java.sql.Date(convertedDate.getTime()); 
									java.sql.Timestamp tim = new java.sql.Timestamp(Date12.getTime());  
									bean.setNew_Change_level_Date(tim);
								} else {
									SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
									convertedDate = formatter.parse(fieldValue); 
									final java.sql.Date Date12 = new java.sql.Date(convertedDate.getTime()); 
							...
							if (fieldName.equalsIgnoreCase("targetdate")) {
								...
								if (val.equalsIgnoreCase("") || val.equalsIgnoreCase(null)) { 
									...
									final java.sql.Date Date12 = new java.sql.Date(convertedDate.getTime()); 
									java.sql.Timestamp tim = new java.sql.Timestamp(Date12.getTime());  
									bean.setTargated_Impl_Date(tim);
								} else {
									SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
									convertedDate = formatter.parse(fieldValue); 
									final java.sql.Date Date12 = new java.sql.Date(convertedDate.getTime()); 
							...
							if (fieldName.equalsIgnoreCase("wip")) {
								bean.setExisting_WIP_Stock(Double.parseDouble(fieldValue));
								//System.out.println(bean.getExisting_WIP_Stock());
							}

							if (fieldName.equalsIgnoreCase("ascast")) {
								bean.setExisting_As_Cast_Stock(Double.parseDouble(fieldValue));
								//System.out.println(bean.getExisting_As_Cast_Stock());
							}

							if (fieldName.equalsIgnoreCase("total")) {
								bean.setTotal_Stock(Double.parseDouble(fieldValue));
								//System.out.println(bean.getTotal_Stock());
							}

							if (fieldName.equalsIgnoreCase("oldtool")) {
								bean.setTooling_Old(Double.parseDouble(fieldValue));
								//System.out.println(Double.parseDouble(fieldValue));
							}
							if (fieldName.equalsIgnoreCase("newtool")) {
								bean.setTooling_New(Double.parseDouble(fieldValue));
								//System.out.println(Double.parseDouble(fieldValue));
							}

							if (fieldName.equalsIgnoreCase("old_fixture")) {
								bean.setFixture_Old(Double.parseDouble(fieldValue));
								//System.out.println(Double.parseDouble(fieldValue));
							}
							if (fieldName.equalsIgnoreCase("new_fixture")) {
								bean.setFixture_New(Double.parseDouble(fieldValue));
								//System.out.println(Double.parseDouble(fieldValue));
							}

							if (fieldName.equalsIgnoreCase("old_gauges")) {
								bean.setGauges_Old(Double.parseDouble(fieldValue));
								//System.out.println(Double.parseDouble(fieldValue));
							}
							if (fieldName.equalsIgnoreCase("new_gauges")) {
								bean.setGauges_New(Double.parseDouble(fieldValue));
								//System.out.println(Double.parseDouble(fieldValue));
							}
							...
							if (fieldName.equalsIgnoreCase("department_selected")) {
								chang_dept.add(fieldValue);
								//System.out.println("Testing departments === " + chang_dept); 
							}
							...
							if (fieldName.equalsIgnoreCase("valReq")) {
								NewReq = Integer.parseInt(fieldValue.toString());
								//System.out.println(Integer.parseInt(fieldValue));
							}
...
/*										int comp_id = 0;
										...
										PreparedStatement ps_plant = con.prepareStatement("select * from user_tbl_planthead where Company_Id="+ comp_id);
										...
										flag = bo.changeRequest(bean, app_list,chang_dept, session);
									}
									// Attach file ====>
