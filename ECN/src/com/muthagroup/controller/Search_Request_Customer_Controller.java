...
import com.muthagroup.bo.Search_Request_Customer_BO;
import com.muthagroup.vo.Search_Request_Customer_Vo;
//============================================================================-->
//============================ Controller  ===================================-->
//============================================================================-->
public class Search_Request_Customer_Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			Search_Request_Customer_Vo bean = new Search_Request_Customer_Vo();
			...
			if (flag == true) {
				response.sendRedirect("Search_Result_Customer.jsp");
			} else {
