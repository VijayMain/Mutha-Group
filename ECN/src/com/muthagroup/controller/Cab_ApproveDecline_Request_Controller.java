...
//============================ Controller  ===================================-->
//============================================================================-->
public class Cab_ApproveDecline_Request_Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			Cab_ApproveDecline_Request_Vo bean = new Cab_ApproveDecline_Request_Vo(request);
			Cab_ApproveDecline_Request_BO bo = new Cab_ApproveDecline_Request_BO();
