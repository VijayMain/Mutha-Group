...
%>
		<div id="templatemo_header" class="ddsmoothmenu">
			<ul>
				...
				<a href="My_Approvals_Customer.jsp"><strong style="font-size: 5mm;"> <== Go Back</strong></a>  
					<form method="post" action="Cab_ApproveDecline_Request_Controller" onsubmit="return(validate());" name="myForm">
						<table style="width: 100%;" class="tftable">
							...
							<tr>
								<td align="center"><label><b style="font-weight: bold;font-size: 12px;"><%=cr_No%></b></label></td>
								...
								<%
											...
											while (rs_item.next()) {
								%>
								<td colspan="2" align="left"><label><%=rs_item.getString("Item_Name")%></label></td>
								<%
									}
								%> 
								<td align="left"><label><%=rs_edit.getString("Change_For")%></label> </td>
								<td align="right"><label><%=rs_edit.getInt("Existing_WIP_Stock")%></label> </td>
								<td align="right"><label><%=rs_edit.getInt("Existing_As_Cast_Stock")%></label> </td>
								<td align="right"><label><%=rs_edit.getInt("Total_Stock")%></label> </td> 
							</tr> 
							<tr>
								<th align="center"><b>Target Impl. Date</b></th>
							...
							%>
 							<tr>
								<th align="right"><b>A. No</b></th>
								<th colspan="2" align="left"><b>Action Description</b></th>
								<th align="left"><b>Action Date</b></th>
								<th colspan="2" align="left"><b>Proposed Output</b></th>
								<th colspan="2" align="left"><b>Actual Output</b></th>
								<th align="left"><b>Attachments</b></th>
							</tr>
							<%
								PreparedStatement ps_action_no = con.prepareStatement("select * from crc_tbl_action where CRC_no=" + cr_No);
								...
								<td>
									<%
										/****************************************************************************************************************
												...
												while (rs_file.next()) {
									%>
									<a href="Display_Customer.jsp?field=<%=rs_file.getString("CRC_Action_File_Name")%>" style="color: green;"><b><%=rs_file.getString("CRC_Action_File_Name")%></b></a><br>
									<%
 										}	
 											}
 									%>
