	...
	<%
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("select * from crc_tbl_action_attachment where CRC_Action_File_Name='"
							+ name + "'");
			ResultSet rs = ps.executeQuery();
			if (rs.next()) {

				Blob blob = rs.getBlob("CRC_Action_Attachment");
