...
%>
		...
		-->
				...
				<a href="My_Approvals.jsp"><strong style="font-size: 5mm;"><== Go Back </strong></a>
 ...
 %>
							...
							<tr>
 							...
 							<tr>
								<th colspan="3" align="center"><b>Requestor </b></th>
								<th colspan="7" align="center"><b>Attachments </b></th>
							</tr>
							<tr>
								...
								<td colspan="7" align="left">
									<%
											...
											while (rs_file1.next()) {
									%>
									<a  href="Display_Attach.jsp?field=<%=rs_file1.getString("File_Name")%>" style="color: green;"><b> <%=rs_file1.getString("File_Name")%></b></a><br>
 									<%
										 	}
 									%>
								</td> 
