				...
				<div style="height: 550px;width: 100%;overflow: scroll;">
					...
					<table style="width: 100%;" class="tftable">   
						<% 
									...
									int cr_No = Integer.parseInt(request.getParameter("hid"));
							...
							<tr style="height: 27px;">
								...
								<th align="center"><b>Request Date</b></th>
								<th align="center"><b>Supplier Name</b></th>
								<th align="center"><b>Part Name</b></th>
								<th align="center"><b>Category Of Change</b></th>
								<th align="center"><b>Type Of Change</b></th>
								<th align="center"><b>Proposed date</b></th>
								<th align="center"><b>Actual Implementation date</b></th>
								<th align="center"><b>ComplaintNo(Optional)</b></th>
							</tr>
							<tr>
								<td align="center"><b style="font-size: 12px;"><%=cr_No%></b></td>
								<td align="left"><label><%=rs_edit.getString("CR_Date")%></label> 
 ...
 %> 
							...
							%> <b>-></b><label><%=rs_type.getString("CR_Type")%></label> <%
 							...
 							%>
								...
								<%
									if (rs_edit.getString("Actual_Impl_Date").equals("0002-11-30 00:00:00.0")) {
								%>
								<td align="left"></td>
								<%
									} else {
							...
							<tr>
								...
								<td colspan="5" align="left">
									<% 
											...
											while (rs_file1.next()) {
									%> 
								<label><a href="Display_Attach.jsp?field=<%=rs_file1.getString("File_Name")%>" style="color: #396E2F"><b> <%=rs_file1.getString("File_Name")%></b></a></label>
									 <%
 											}
 									%>
								</td> 
							...
							<tr>
								<th colspan="3" align="center"><b>Approver Name</b></th>
								<th colspan="2" align="center"><b>Approve Type</b></th>
								<th colspan="1" align="center"><b>Approve Date</b></th>
							...
							<tr>
								<%
									PreparedStatement ps_U_Name = con.prepareStatement("select distinct(U_Name) from user_tbl where U_Id="
															+ rs_appr_details.getInt("U_Id")); 
											ResultSet rs_U_Name = ps_U_Name.executeQuery(); 
											while (rs_U_Name.next()) {
								%>
								<td colspan="3" align="left"><%=rs_U_Name.getString("U_Name")%>
								</td>
								<%
									} 
								...
								%>
								<td colspan="1" align="left"><%=rs_Remark.getTimestamp("CR_Approval_Date")%></td>
							...
							<tr>
								...
								<input type="button" value=" Delete " onclick="showState(<%=rs_file.getInt("Cr_Attach_Id")%>)">
								</label><br>
									<%
 									}
 										}
						...
						%>
						  <tr>
								<td colspan="4"><b>Action Description</b></td>
							...
							<tr>
								<td colspan="4"><b>Proposed Date</b><br> 
								...
								<td colspan="5"><b>Actual Implementation Date</b><br> 
							...
							<tr>
								...
								<input type="submit" value="Click to Add Action" style="height: 35px; width: 200px; background-color: #C4C4C4; border-radius: 20px/20px;font-weight: bold;color: green;" onclick="Go();"> 
								<input type="hidden" name="mytext" id="mytext"> <a href="Cab_Home.jsp" style="font-size: 11px;font-weight: bold;color: blue;">Back To Home</a></td>
							</tr> 
						...
						%>
							<tr>
								<td colspan="9" align="left" style="background-color: #388eab;color: white;font-size: 12px;"><b>Choose Actions</b></td>
							</tr>
							<tr>
								<td  colspan="9">
								<select name="Action_No" id="Action_No" style="background-color: #dcf1f8">
										<%
							...
							<tr>
								<td colspan="9"><b>Actual Output</b></td>
							</tr>
							<tr>
								<td colspan="9">
								<textarea name="actual_output" id="actual_output" cols="30" rows="4" style="background-color: #dcf1f8"></textarea>
								</td> 
							</tr>
							<tr>
								<td colspan="9"><b>Actual Implementation Date</b><br> 
								<input id="demo4" name="act_impl_date_op" type="text" size="25" readonly="readonly" style="background-color: #dcf1f8"> <a href="javascript:NewCal('demo4','ddmmyyyy',true,24)"> 
							...
							<tr>
								<td colspan="9"><b>ATTACH FILE (Optional) </b><br>
									<table id="tblSample">
										<tr style="padding-top: 10px;">
										 <td><strong> 
											<input type="button" value="  ADD More Files  " name="button" onclick="addRowToTable();" /></strong></td>
											<td><input type="button" value=" Delete[Selected] " onclick="deleteChecked();" />&nbsp;&nbsp; 
											<input type="hidden" id="srno" name="srno" value=""></td>
										</tr>
										<tbody></tbody>
							...
							<tr>
								<td align="left" colspan="9">
								<input type="submit" value="Add Actual Output" style="height: 35px; width: 200px; background-color: #C4C4C4; border-radius: 20px/20px;font-weight: bold;" onclick="Go1();"> 
								<input type="hidden" name="mytextAct" id="mytextAct"><a href="Cab_Home.jsp" style="font-size: 11px;font-weight: bold;color: blue;">Back To Home</a>
								</td>
							</tr>
						</table> 
						<%
