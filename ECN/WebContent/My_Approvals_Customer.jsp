...
<body id="sub_page">
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_main">
			<h4 style="color: white;">My Approvals Customer</h4>
			<div class="col_w630 float_l">
				<div id="contact_form">
					...
					<form method="post" name="approve"
						action="My_Approvals_Result_Customer.jsp" id="approve">
						<%
								...
								<tbody>
									...
									<tr onmouseover="ChangeColor(this, true);"
										...
										<%
															...
															ResultSet rs_appr_list = ps_appr_list
																	.executeQuery();
															...
															for (int appr = 0; appr < appr_list.size(); appr++) {
																PreparedStatement ps_appr = con
																		.prepareStatement("select Approval_Id from crc_tbl_Approval where CRC_No="
																				+ cr_no
																				+ " and U_Id="
																				+ Integer.parseInt(appr_list
																						.get(appr).toString()));

																ResultSet rs_appr = ps_appr.executeQuery();
																while (rs_appr.next()) {
																	appr_id_list.add(rs_appr
																			.getInt("Approval_Id"));
																}
