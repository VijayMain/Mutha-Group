...
<!--============================================================================-->
		...
		<div id="templatemo_main">
			<h4 style="color: white;">Add Action</h4>
			<div class="col_w630 float_l">
				...
				<div id="templatemo_header" class="ddsmoothmenu">
					...
					<form method="post" name="action" action="Add_Action_Details.jsp"
						id="action">
						<%
							int cr_no = 0;
								...
								PreparedStatement ps_Cr_No = con
										.prepareStatement("select Cr_no from cr_tbl where U_Id="
												+ uid);
							...
							<table width="1000px">
								<tbody>
									...
									<tr onmouseover="ChangeColor(this, true);"
										...
										<td align="center" width="110px"><%=rs_action.getString("CR_Date")%>

											<input type="hidden" name="req_date"
											value="<%=rs_action.getString("CR_Date")%>"></td>
										<td align="center" width="110px"><%=rs_action.getString("Proposed_Impl_Date")%></td>
										...
										%>
											...
											<td align="center" width="110px"><%=rs_action.getString("Actual_Impl_Date")%></td>
