		...
		<div id="templatemo_main">
			...
			<div class="col_w630 float_l">
				<div id="contact_form">
					...
					<div id="templatemo_header" class="ddsmoothmenu">
						...
						<ul>
							<li style="background-color: #B3A6AA;"><a
								href="My_Approvals.jsp">Internal</a></li>
							<li style="background-color: #B3A6AA;"><a
								href="My_Approvals_Customer.jsp">Customer</a></li>
							<li style="background-color: #B3A6AA;"><a
								href="All_Requests.jsp">All Requests</a></li>
						</ul>
					</div>
					...
					<form method="post" name="approve" action="My_Approvals_Result.jsp"
						id="approve">
						<%
