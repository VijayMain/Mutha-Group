			...
			<ul>
				...
				<div id="templatemo_header" class="ddsmoothmenu" style="width: 100%">
						<ul>
							...
							<li style="background-color: #1c6f8a;color: white;"><a href="All_Requests.jsp"><b>All Internal</b></a></li>
					...
					<form method="post" name="approve" action="Internal_Request_Result.jsp" id="approve">
						<%
