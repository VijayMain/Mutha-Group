...
<body id="sub_page">
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_main">
			<table>
				<tr>
					<td colspan="2"><h4 style="color: white; margin-bottom: 12px;">Home Customer
						</h4></td>
				</tr>
			</table>
			...
			<div class="col_w630 float_l">
				<div id="contact_form">
						...
						ResultSet rs_uidappr = ps_uidappr.executeQuery();
							...
							for (int s = 0; s < id1.size(); s++) {
								...
								while (rs_ap_id.next()) {
									...
									System.out
											.print("CR No..." + rs_ap_id.getInt("CRC_No"));
					...
					<form method="post" name="edit"
						action="Cab_ApproveDecline_Request_Customer.jsp" id="edit">
						<table width="1100px">
							...
							<table width="1100">
								...
								<tbody>
									...
									<tr onmouseover="ChangeColor(this, true);"
										...
										<td align="center" width="110px"><%=rs_CR_Details.getString("Total_Stock")%></td>
