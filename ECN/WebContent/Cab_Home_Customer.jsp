...
PreparedStatement ps_CR_Details = con.prepareStatement("select * from CRC_tbl where CRC_No=" + Integer.parseInt(approval_list.get(f).toString()) + " and Company_Id in ("+Integer.parseInt(compIDList.get(0).toString())+") order by CRC_date"); 
...
PreparedStatement ps_CR_Details = con.prepareStatement("select * from CRC_tbl where CRC_No=" + Integer.parseInt(approval_list.get(f).toString()) + " and Company_Id in ("+Integer.parseInt(compIDList.get(1).toString())+") order by CRC_date"); 
												ResultSet rs_CR_Details = ps_CR_Details.executeQuery();
												int cr_no = 0;
												while (rs_CR_Details.next()) {
													cr_no = rs_CR_Details.getInt("CRC_No");
...
PreparedStatement ps_CR_Details = con.prepareStatement("select * from CRC_tbl where CRC_No=" + Integer.parseInt(approval_list.get(f).toString()) + " and Company_Id in ("+Integer.parseInt(compIDList.get(2).toString())+") order by CRC_date"); 
												ResultSet rs_CR_Details = ps_CR_Details.executeQuery();
												int cr_no = 0;
												while (rs_CR_Details.next()) {
													cr_no = rs_CR_Details.getInt("CRC_No");
...
PreparedStatement ps_CR_Details = con.prepareStatement("select * from CRC_tbl where CRC_No=" + Integer.parseInt(approval_list.get(f).toString()) + " and Company_Id in ("+Integer.parseInt(compIDList.get(3).toString())+") order by CRC_date"); 
												ResultSet rs_CR_Details = ps_CR_Details.executeQuery();
												int cr_no = 0;
												while (rs_CR_Details.next()) {
													cr_no = rs_CR_Details.getInt("CRC_No");
...
PreparedStatement ps_CR_Details = con.prepareStatement("select * from CRC_tbl where CRC_No=" + Integer.parseInt(approval_list.get(f).toString()) + " and Company_Id in ("+Integer.parseInt(compIDList.get(4).toString())+") order by CRC_date"); 
												ResultSet rs_CR_Details = ps_CR_Details.executeQuery();
												int cr_no = 0;
												while (rs_CR_Details.next()) {
													cr_no = rs_CR_Details.getInt("CRC_No");
...
PreparedStatement ps_CR_Details = con.prepareStatement("select * from CRC_tbl where CRC_No=" + Integer.parseInt(approval_list.get(f).toString()) + " and Company_Id in ("+Integer.parseInt(compIDList.get(5).toString())+") order by CRC_date"); 
												ResultSet rs_CR_Details = ps_CR_Details.executeQuery();
												int cr_no = 0;
												while (rs_CR_Details.next()) {
													cr_no = rs_CR_Details.getInt("CRC_No");
